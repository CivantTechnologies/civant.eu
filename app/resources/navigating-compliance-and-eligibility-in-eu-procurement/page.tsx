...
export const metadata = buildArticleMetadata({
  ...
  description:
    "Public procurement is governed by laws and regulations that set out how contracts must be tendered and awarded. Suppliers must meet eligibility criteria and ...",
  path: pagePath,
