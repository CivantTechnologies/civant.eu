...
export const metadata = buildArticleMetadata({
  ...
  description:
    "The Procurement Act 2023 introduces planned procurement notices (PPNs) as a tool for early transparency and streamlined competition. By issuing a PPN months ...",
  path: pagePath,
      ...
      <Section muted>
        <div className="article-shell">
          ...
          <article className="card article-card">
            ...
            <p className="article-copy">
              PPNs specify the subject matter of the future procurement, estimated timelines and any market engagement activities. Once a PPN is issued, authorities may reduce the tender period from the default 30 or 35 days to a shorter duration【260720734738020†L284-L289】. This places the onus on suppliers to monitor early notices and be ready to bid on short notice. If suppliers ignore PPNs, they may be surprised by a compressed tender window and struggle to assemble a competitive bid.
            </p>
          </article>
          ...
          <article className="card article-card">
            ...
            <p className="article-copy">
              The timeline under a PPN follows a specific pattern: publication of the notice, optional pre‑market engagement, and then the formal contract notice with a shortened tender period【215481272335041†L603-L611】. Authorities use PPNs to speed up procurement cycles, particularly for urgent or straightforward procurements. However, this practice can disadvantage suppliers who do not monitor early notices, especially SMEs with limited bid capacity.
            </p>
          </article>
