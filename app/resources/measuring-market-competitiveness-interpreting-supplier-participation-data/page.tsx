...
export const metadata = buildArticleMetadata({
  ...
  description:
    "Deciding whether to bid on a tender requires understanding how competitive the market is. Supplier participation data—from the number of bids received to the...",
  path: pagePath,
      ...
      <Section muted>
        <div className="article-shell">
          ...
          <article className="card article-card">
            ...
            <p className="article-copy">
              In some categories, tenders attract dozens of bidders, reflecting low barriers to entry and commoditised requirements. Other procurements—particularly those with complex specifications or high risk—may attract only a handful of bids. High incumbent concentration reduces participation and discourages new entrants【955963253296062†L104-L110】. Variations in participation are influenced by contract size, complexity and market maturity.
            </p>
          </article>
