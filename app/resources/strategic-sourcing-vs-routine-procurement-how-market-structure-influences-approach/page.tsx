...
export const metadata = buildArticleMetadata({
  ...
  description:
    "Not all public procurement is created equal. Strategic categories involve complex solutions, long‑term relationships and higher contract values, whereas rout...",
  path: pagePath,
      ...
      <Section muted>
        <div className="article-shell">
          ...
          <article className="card article-card">
            ...
            <p className="article-copy">
              Strategic sourcing typically involves frameworks or large one‑off contracts with comprehensive specifications, such as ICT systems, professional services or infrastructure projects【811032459588661†L309-L323】. Buyers invest time in pre‑market engagement and supplier relationship management for these categories. Routine procurement, by contrast, may employ DPS or simple one‑off tenders for commoditised items such as office supplies or janitorial services【811032459588661†L330-L337】. These categories prioritise price and compliance over innovation and are often re‑tendered frequently.
            </p>
          </article>
