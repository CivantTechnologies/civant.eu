    ...
    <>
      ...
      <Section muted>
        <div className="article-prose">
          ...
          <h2 className="article-subheading">Digital Procurement</h2>
          ...
          <h2 className="article-subheading">Platform Effects</h2>
          ...
          <h2 className="article-subheading">System Transformation</h2>
