...
export const metadata = buildArticleMetadata({
  ...
  description:
    "Public buyers use various procurement mechanisms to streamline purchases and comply with regulations. Two common tools—framework agreements and dynamic purch...",
  path: pagePath,
      ...
      <Section muted>
        <div className="article-shell">
          ...
          <article className="card article-card">
            ...
            <p className="article-copy">
              Framework agreements are widely used for categories such as consultancy, IT services and facilities management. They simplify procurement by enabling call‑offs without repeating the full tender process and typically last two to four years【811032459588661†L314-L323】. Because frameworks are closed, new entrants cannot join until the next renewal, and incumbents enjoy stable pipelines. DPS, by contrast, are designed for high‑volume or commoditised goods and remain open for suppliers to join at any time【811032459588661†L330-L337】. Every call‑off under a DPS is a mini‑competition, which ensures ongoing competition but can create administrative overhead for suppliers.
            </p>
          </article>
          ...
          <article className="card article-card">
            ...
            <p className="article-copy">
              Frameworks and DPS exhibit distinct patterns. Frameworks are created through a one‑off competition and then operate for a set term with extension options【811032459588661†L314-L323】. During their life, the membership is fixed, and call‑off contracts are awarded among panel members. DPS remain open; suppliers meeting the criteria can join at any time and participate in call‑offs【811032459588661†L330-L337】. Because DPS call‑offs can be frequent, suppliers must manage continuous bidding activity, whereas frameworks demand intensive effort upfront but provide stability thereafter.
            </p>
          </article>
