...
export const metadata = buildArticleMetadata({
  ...
  description:
    "Small and medium enterprises (SMEs) are the backbone of Europe’s economy, yet they struggle to win a proportionate share of public procurement spend. Despite...",
  path: pagePath,
      ...
      <Section muted>
        <div className="article-shell">
          ...
          <article className="card article-card">
            ...
            <p className="article-copy">
              SME participation patterns reveal a paradox: SMEs win many low‑value contracts but seldom secure large, high‑value frameworks. In the Netherlands, SMEs win 57 % of contracts but only 28 % of the total value; in Germany, they capture just 20–25 %【955963253296062†L59-L66】. Several dynamics contribute to this disparity. Complex compliance requirements and substantial bid documentation favour larger organisations with dedicated bid teams. Fragmented tender discovery across multiple portals increases the cost of finding opportunities【955963253296062†L97-L103】. Perception bias and incumbent preference among buyers further reduce the likelihood that SMEs will win larger contracts【955963253296062†L104-L110】.
            </p>
          </article>
          ...
          <article className="card article-card">
            ...
            <p className="article-copy">
              Structural barriers manifest in contract structures and procurement processes. Large frameworks tend to bundle multiple services, raising thresholds for participation and excluding smaller suppliers. Long contract durations entrench incumbents and reduce the frequency of open competitions【811032459588661†L314-L323】. Thresholds for EU‑level notices mean that many sub‑threshold contracts are procured locally, often using processes unfamiliar to SMEs from outside the region. SMEs often lack the resources to monitor numerous local portals and interpret varying procedural requirements.
            </p>
          </article>
