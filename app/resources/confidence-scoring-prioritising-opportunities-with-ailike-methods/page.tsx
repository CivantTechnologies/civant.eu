...
export const metadata = buildArticleMetadata({
  ...
  description:
    "Not all tenders are equally attractive. Suppliers must decide where to invest their limited bid resources. Confidence scoring provides a structured way to ev...",
  path: pagePath,
      ...
      <Section muted>
        <div className="article-shell">
          ...
          <article className="card article-card">
            ...
            <p className="article-copy">
              Procurement intelligence platforms integrate confidence scoring into their dashboards, combining historical win data with current market signals【20486665374544†L47-L50】. These tools allow users to adjust scoring criteria to reflect internal priorities, such as focusing on sectors with long‑term growth. They also provide transparency on the factors driving each score, fostering trust and adoption among bid teams.
            </p>
          </article>
