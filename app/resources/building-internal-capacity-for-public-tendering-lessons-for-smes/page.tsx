...
export const metadata = buildArticleMetadata({
  ...
  description:
    "Participating in public tenders requires more than just identifying opportunities. SMEs in particular must develop internal capacity—people, processes and sy...",
  path: pagePath,
